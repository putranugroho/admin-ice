...
const dataCourseEdx = require("../../data/reportCourseEdx.json");
const dataUserEdx = require("../../data/reportUserEdx.json");
...
const PesertaEdx = () => {
  ...
  useEffect(() => {
    if (dataUserEdx.length !== 0) {
      ...
      for (let i = 0; i < dataUserEdx.length; i++) {
        if (dataUserEdx[i].tipe_peserta === "Lecturer") {
          countDosen = countDosen + 1
        } else if (dataUserEdx[i].tipe_peserta === "Student") {
          countMahasiswa = countMahasiswa + 1
        } else if (dataUserEdx[i].tipe_peserta === "Public") {
          countUmum = countUmum + 1
        } else {
          countStaff = countStaff + 1
        }
        if (dataUserEdx[i].status_perguruan_tinggi === "Konsorsium") {
          countKonsorsium = countKonsorsium + 1
        } else if (dataUserEdx[i].status_perguruan_tinggi === "Non Konsorsium") {
          countNon = countNon + 1
        } else if (dataUserEdx[i].status_perguruan_tinggi === "Provider") {
          countProvider = countProvider + 1
        } else if (dataUserEdx[i].status_perguruan_tinggi === "Public") {
          countPublic = countPublic + 1
        }
        if (dataUserEdx[i].gender === "Male") {
          countMale = countMale + 1
        } else if (dataUserEdx[i].gender === "Female") {
          countFemale = countFemale + 1
        }
        countTotalUser = countTotalUser + dataUserEdx[i].total_course_title
      }
      ...
      jenisPeserta1[0].percentage = (countProvider / dataUserEdx.length * 100).toString().slice(0,4)
      jenisPeserta1[1].percentage = (countPublic / dataUserEdx.length * 100).toString().slice(0,4)
      jenisPeserta1[2].percentage = (countKonsorsium / dataUserEdx.length * 100).toString().slice(0,4)
      jenisPeserta1[3].percentage = (countNon / dataUserEdx.length * 100).toString().slice(0,4)
